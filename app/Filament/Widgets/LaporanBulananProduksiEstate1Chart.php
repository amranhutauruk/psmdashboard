...
class LaporanBulananProduksiEstate1Chart extends ChartWidget
{
   protected static ?string $heading = 'Laporan Bulanan Produksi Estate 1';
   ...
   {
       $years = LaporanBulananProduksiEstate1::query()
           ->select('year')
           ->distinct()
           ->orderBy('year', 'desc')
           ->pluck('year')
   ...
   protected function getData(): array
   {
       ...
       $data = LaporanBulananProduksiEstate1::query()
