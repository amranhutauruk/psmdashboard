...
class LaporanProduksiPlasmaChart extends ChartWidget
{
   protected static ?string $heading = 'Laporan Produksi Plasma';
   ...
   {
       $years = LaporanProduksiPlasma::query()
           ->select('year')
           ->distinct()
           ->orderBy('year', 'desc')
           ->pluck('year')
   ...
   protected function getData(): array
   {
       ...
       $data = LaporanProduksiPlasma::query()
