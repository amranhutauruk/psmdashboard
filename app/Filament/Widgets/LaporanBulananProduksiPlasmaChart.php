...
class LaporanBulananProduksiPlasmaChart extends ChartWidget
{
   protected static ?string $heading = 'Laporan Bulanan Produksi Plasma';
   ...
   {
       $years = LaporanBulananProduksiPlasma::query()
           ->select('year')
           ->distinct()
           ->orderBy('year', 'desc')
           ->pluck('year')
   ...
   protected function getData(): array
   {
       ...
       $data = LaporanBulananProduksiPlasma::query()
